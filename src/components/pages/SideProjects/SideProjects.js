            ...
            <div className="SideProjects">
                ...
                <p>
                    <Words animate anim={this.props.anim.entered}>
                        ...
                        Here you can view a gallery of some of my artwork or listen to some of the music I've made or playlists I've put together.
                    </Words>
                </p>
                <Button animate show={this.props.anim.entered} style={{ margin: '10px' }} onClick={this.setShowGallery}>Art Gallery</Button>
                <Button animate show={this.props.anim.entered} style={{ margin: '10px' }} onClick={this.setShowDJ}>Music</Button>
